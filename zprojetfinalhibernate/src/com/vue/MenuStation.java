...
public class MenuStation extends JFrame {
	...
	public MenuStation() {
		...
		lesStation = new ArrayList<Station>();
		lesStation=AccesData.getListeStation();
	...
	private void affichageStation() {
		this.setContentPane(new PanelStation(lesStation));
		this.revalidate();
	}
	private void affichageListeBorneStation() {
		this.setContentPane(new PanelBorneStation(lesStation));
		this.revalidate();
	}
	private void affichageAjoutBorne() 	{
		this.setContentPane(new PanelAjoutBorne(lesStation));
		this.revalidate();
	}
	private void affichageBorneTypeCharge() {
		this.setContentPane(new PanelBorneTypeCharge(lesStation));
		this.revalidate();
	}
}
